...
import { FormAnswer } from '../../components/services/faq/form-answer';
...
const SendForm: React.FC<Props> = ({ fetchData }) => {
  const { superPromotion, picModerateYear } = fetchData;
  ...
  const titleH1 = 'h1' in seoForPage && seoForPage?.h1?.length > 0 ? seoForPage.h1 : 'Задать вопрос';
